...
export const BlogsData = [
    {
        date: "4-3-2023",
        title: "Pytorch serve",
        description: "How to use PyTorch Serve explained in easy and simple terms",
        id: "123123123",
...
export const ExperienceData = [
    {
        ...
        description: "Intelligent document processing software. Responsible for integrating model deployment, testing and training features to the platform. Integrated new ocr solutions and developed document processing testing tools.",
        tags: [
            "Nodejs",
            "Tensorflow",
            "Vuejs",
    ...
    },
    {
        ...
        description: "Developed a data validation library that validated 100,000 messages and events per second generated by uber and uber eats.",
        tags: [
            "Golang",
            "Apache Kafka",
            "Apache Flink",
    ...
    },
    {
        ...
        description: "Worked with clients for developing web applications.",
        tags: [
            "Nextjs",
            "Vercel",
            "Postgresql",
